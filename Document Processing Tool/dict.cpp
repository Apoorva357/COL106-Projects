...
void dfs(Node* n,string p,ofstream& fil){
...
void Dict::insert(string s){
   ...
   // for(int i = 0;i<52;i++){
         //Node* l = new Node('-');
    n->children = vector<Node*>(54,nullptr);
   // }
...
//int l = search(root->children,s[i]);
    ...
    while(i<k){
        ...
        if(l == 0){
           ...
           // }
            ...
            if(n->children[h] == nullptr){return -1;}
            n = n->children[h];
